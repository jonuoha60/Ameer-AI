...
func NewRouter(database *mongo.Database, cfg config.Config) *gin.Engine {
	...
	userList.RegisterRoutes(r, database, cfg.JWTRefresh, cfg.JWTAccess, cfg.FireBase)
	...
	trips.RegisterRoutes(r, database, cfg.JWTAccess)
	experience.RegisterRoutes(r, database, cfg.JWTAccess)
